...
/**
 * Primary content in *TextAndImages → Default → Primary*
 */
export interface TextAndImagesSliceDefaultPrimary {
  /**
   * Theme field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.theme
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  theme: prismic.SelectField<"Blue" | "Orange" | "Navy" | "Lime">;

  /**
   * Heading field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Button field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.button
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  button: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;

  /**
   * Background Image field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.background_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  background_image: prismic.ImageField<never>;

  /**
   * Foreground Image field in *TextAndImages → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.default.primary.foreground_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
...
/**
 * Default variation for TextAndImages Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TextAndImagesSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<TextAndImagesSliceDefaultPrimary>,
  never
>;

/**
 * Primary content in *TextAndImages → Image on Left → Primary*
 */
export interface TextAndImagesSliceImageOnLeftPrimary {
  /**
   * Theme field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.theme
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
  theme: prismic.SelectField<"Blue" | "Orange" | "Navy" | "Lime">;

  /**
   * Heading field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  body: prismic.RichTextField;

  /**
   * Button field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.button
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  button: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;

  /**
   * Background Image field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.background_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  background_image: prismic.ImageField<never>;

  /**
   * Foreground Image field in *TextAndImages → Image on Left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_images.imageOnLeft.primary.foreground_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  foreground_image: prismic.ImageField<never>;
}
...
/**
 * Image on Left variation for TextAndImages Slice
 *
 * - **API ID**: `imageOnLeft`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TextAndImagesSliceImageOnLeft = prismic.SharedSliceVariation<
  "imageOnLeft",
  Simplify<TextAndImagesSliceImageOnLeftPrimary>,
  never
>;

/**
 * Slice variation for *TextAndImages*
 */
type TextAndImagesSliceVariation =
  | TextAndImagesSliceDefault
  | TextAndImagesSliceImageOnLeft;

/**
 * TextAndImages Shared Slice
 *
 * - **API ID**: `text_and_images`
 * - **Description**: TextAndImages
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TextAndImagesSlice = prismic.SharedSlice<
  "text_and_images",
  TextAndImagesSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      TextAndImagesSlice,
      TextAndImagesSliceDefaultPrimary,
      TextAndImagesSliceImageOnLeftPrimary,
      TextAndImagesSliceVariation,
      TextAndImagesSliceDefault,
      TextAndImagesSliceImageOnLeft,
      VideoBlockSlice,
