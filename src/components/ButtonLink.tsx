  ...
  return (
    <PrismicNextLink
      className={clsx(
        ...
        size === "md" && "gap-3 px-1 text-lg py-[clamp(0.625rem,1.5vw,0.75rem)]",
        size === "lg" && "text-[clamp(1.125rem,4vw,1.5rem)] gap-[clamp(0.75rem,2vw,1rem)] px-[clamp(0.25rem,1vw,0.5rem)] py-[clamp(0.75rem,2vw,1rem)]",
        color === "orange" &&
          "bg-orange-500 hover:bg-lime-400 text-black hover:text-black",
        color === "purple" &&
          "bg-purple-500 hover:bg-lime-400 text-white hover:text-black",
        color === "lime" && "bg-lime-400 hover:bg-orange-500 text-black",
        className,
      )}
      {...props}
    >
        ...
        <>
          <div
            className={clsx(
              ...
              size === "sm" && "size-5",
              size === "md" && "size-6",
              size === "lg" && "h-[clamp(1.5rem,4vw,2rem)] w-[clamp(1.5rem,4vw,2rem)]",
            )}
          >
