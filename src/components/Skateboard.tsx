...
export function Skateboard({
  ...
  const gripTapeMaterial = useMemo(() => {
    const material = new THREE.MeshStandardMaterial({
      map: gripTapeDiffuse, // Base color
      bumpMap: gripTapeRoughness, // Bump map for surface height
      bumpScale: 3.5, // How strong the bumps appear
      roughnessMap: gripTapeRoughness, // Defines local shininess
      roughness: 0.8, // Overall roughness
      color: "#ffffff", // Base/fallback color
    });
